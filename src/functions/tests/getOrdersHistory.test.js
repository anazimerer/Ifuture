...
import { getOrdersHistory } from '../axios';
...
describe('getOrdersHistory', () => {
  it('should get orders history from API', async () => {
    const resolvedData = {
      data: {
        orders: 'info',
      },
    ...
    axiosGetOrdersHistory.mockResolvedValue({ data: resolvedData });

    const returnedData = await getOrdersHistory();
  ...
  it('should catch errors', async () => {
    ...
    axiosGetOrdersHistory.mockResolvedValue(Promise.reject(resolvedData));
